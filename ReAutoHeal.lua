...
do
    ...
    elseif mq.TLO.Group.Member(1).PctHPs() <= 65 or mq.TLO.Group.Member(2).PctHPs() <= 65 then
        ...
        heal2()
    elseif mq.TLO.Group.Member(1).PctHPs() == 100 and mq.TLO.Me.PctManaMana() == 100 then
